...
class CommentRepository:
    ...
    async def create(self, comment: CommentCreate, author_id: str) -> DocumentComment:
        ...
    ...
    async def update(self, comment_id: UUID, comment_update: CommentUpdate) -> Optional[DocumentComment]:
        ...
